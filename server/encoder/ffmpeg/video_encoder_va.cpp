        ...
        cmd_pool{make_cmd_pool(vk, stream_idx)}
{
	...
	// GPU timestamps for the Vulkan→VAAPI luma/chroma copy.
	ts_pool = gpu_timestamp_pool(vk, vk.queue.family_index, num_slots, std::format("va encoder {} timestamp pool", stream_idx));
}
