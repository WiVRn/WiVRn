...
#pragma GCC diagnostic pop
	...
	// GPU timestamps for the Vulkan→CUDA copy.
	ts_pool = gpu_timestamp_pool(vk, vk.queue.family_index, num_slots, std::format("nvenc encoder {} timestamp pool", stream_idx));
}
