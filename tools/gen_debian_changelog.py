...
def write_entry(
    ...
    out.writelines(ITEM.format(text=item) for item in data)
...
def main():
    ...
    if args.metainfo:
        ...
        default_metainfo = os.path.join(
            os.path.dirname(__file__), "../dashboard/io.github.wivrn.wivrn.metainfo.xml"
        )
        with open(default_metainfo) as metainfo:
