...
void main()
{
    ...
    vec3 normal_unit = TBN * sampled_normal;
...
//         out_color = vec4(emissive_color + albedo.rgb * (max(0, dot(normal, light_dir)) * scene.light_color.rgb + scene.ambient_color.rgb), albedo.a);
