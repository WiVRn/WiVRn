...
std::shared_ptr<renderer::material> scene_renderer::create_default_material(vk::raii::CommandPool & cb_pool)
{
	...
	default_material->metallic_roughness_texture = create_default_texture(cb_pool, {255, 255}, "Defautl metallic roughness");
	default_material->occlusion_texture = create_default_texture(cb_pool, {255}, "Default occlusion");
	default_material->emissive_texture = create_default_texture(cb_pool, {0, 0, 0, 0}, "Default emissive");
